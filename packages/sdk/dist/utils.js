...
var buildCreate2Address = function buildCreate2Address (
  creatorAddress,
  saltHex,
  byteCode
) {
...
var computeBytecode = function computeBytecode (masterCopyAddress) {
  var bytecode = '0x363d3d373d3d3d363d73'.concat(
    masterCopyAddress.slice(2),
...
var computeProxyAddress = function computeProxyAddress (
  factoryAddress,
      ...
      return _regenerator['default'].wrap(function _callee$ (_context) {
        while (1) {
          switch ((_context.prev = _context.next)) {
            case 0:
              ;(linkdropSigner = _ref.linkdropSigner),
                (weiAmount = _ref.weiAmount),
              ...
              ;(_generateAccount = generateAccount()),
                (linkId = _generateAccount.address),
                (linkKey = _generateAccount.privateKey)
              _context.next = 4
              return signLink({
      ...
      return _regenerator['default'].wrap(function _callee2$ (_context2) {
        while (1) {
          switch ((_context2.prev = _context2.next)) {
            case 0:
              ;(linkdropSigner = _ref3.linkdropSigner),
                (weiAmount = _ref3.weiAmount),
                (tokenAddress = _ref3.tokenAddress),
                (tokenAmount = _ref3.tokenAmount),
      ...
      return _regenerator['default'].wrap(function _callee3$ (_context3) {
        while (1) {
          switch ((_context3.prev = _context3.next)) {
            case 0:
              ;(linkdropSigner = _ref5.linkdropSigner),
                (weiAmount = _ref5.weiAmount),
                (nftAddress = _ref5.nftAddress),
                (tokenId = _ref5.tokenId),
                (expirationTime = _ref5.expirationTime),
                (version = _ref5.version),
                (chainId = _ref5.chainId),
                (proxyAddress = _ref5.proxyAddress)
              ;(_generateAccount2 = generateAccount()),
                (linkId = _generateAccount2.address),
                (linkKey = _generateAccount2.privateKey)
              _context3.next = 4
      ...
      return _regenerator['default'].wrap(function _callee4$ (_context4) {
        while (1) {
          switch ((_context4.prev = _context4.next)) {
            case 0:
              ;(linkdropSigner = _ref7.linkdropSigner),
                (weiAmount = _ref7.weiAmount),
                (nftAddress = _ref7.nftAddress),
                (tokenId = _ref7.tokenId),
                (expirationTime = _ref7.expirationTime),
                (version = _ref7.version),
                (chainId = _ref7.chainId),
                (linkId = _ref7.linkId),
                (proxyAddress = _ref7.proxyAddress)
              messageHash = ethers.utils.solidityKeccak256(
                [
                  'uint',
                  'address',
